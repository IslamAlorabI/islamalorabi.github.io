document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            'apps.salattimes.android.name': 'Salat Times',
            'apps.salattimes.android.desc': 'A comprehensive Prayer Times app for Android with Adhan notifications, Qibla direction, home screen widget, and accurate prayer times based on your location.',
        ...
        ar: {
            ...
            'apps.salattimes.android.name': 'مواقيت الصلاة',
            'apps.salattimes.android.desc': 'تطبيق شامل لمواقيت الصلاة للأندرويد مع إشعارات الأذان، اتجاه القبلة، ويدجت الشاشة الرئيسية، ومواقيت صلاة دقيقة بناءً على موقعك.',
